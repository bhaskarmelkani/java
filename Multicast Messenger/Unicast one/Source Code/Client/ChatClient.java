...
f = new JFrame("CHAT MESSENGER - CLIENT!!!");
f.setLayout(null);
f.setSize(570,600);
...
lo=new JButton("CONNECT");
f.add(lo);
lo.setBounds(377,480,150,30);

l5=new JLabel("IP Address of Server :");
f.add(l5);
l5.setBounds(30,530,160,30);

ta4 = new JTextField();
f.add(ta4);
ta4.setBounds(160,530,150,30);
...
Runnable r = new ClientThread(ta1,ta2,ta3,ta4);
